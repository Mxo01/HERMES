...
import { bandPath, createScale, gridValues, padExtent, smoothPath } from '@/lib/svg'
import { formatDayShort, formatMetric, formatTick, formatWeekday } from '@/lib/format'
import { withAlpha } from '@/lib/metrics'
import type { DailyPoint, Metric } from '@/lib/types'
        ...
        <>
          ...
          <ChartTooltip
            ...
            rows={[
              ...
              { label: 'Min', value: formatMetric(day.min, metric), color: withAlpha(accent, 0.45) },
              ...(day.alarms
                ? [{ label: 'Alarms', value: `▲ ${day.alarms}`, color: 'var(--color-signal-alert)' }]
                : []),
            ]}
